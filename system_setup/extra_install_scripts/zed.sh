...
# TODO: chsnge name to zedit. use the following?

#       mv "$HOME/.local/share/applications/zed.desktop" "$HOME/.local/share/applications/zedit.desktop"
#       sed -i 's/Name=Zed/Name=Zedit/' "$HOME/.local/share/applications/zedit.desktop"
